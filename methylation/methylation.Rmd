...
3. Association analysis, or differential methylation
    ...
    - `limma` for differentially methylated tegions
...
- Analyze genomic location of CpG sites, using genomic coordinates
    ...
    - **GenomeRunner** - functional interpretation of genomic regions within regulatory context, http://integrativegenomics.org/
...
- **minfi**	- normalization, analysis and visualization	http://www.bioconductor.org/packages/release/bioc/html/minfi.html
...
- **RnBeads** (F. Mueller et al.) works for 450K arrays, BS-Seq, MeDIP or MBD-Seq data https://bioconductor.org/packages/release/bioc/html/RnBeads.html
